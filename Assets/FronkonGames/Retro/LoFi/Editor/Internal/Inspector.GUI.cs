...
namespace FronkonGames.Retro.LoFi
{
  ...
  public abstract partial class Inspector
  {
    ...
    public static float Slider(string label, string tooltip, float value, float resetValue = 1.0f) => Slider(label, tooltip, value, 0.0f, 1.0f, resetValue);
    ...
    public static Gradient GradientField(string label, string tooltip, Gradient value, GradientColorKey[] resetValue)
    {
      EditorGUILayout.BeginHorizontal();
      {
        ...
        if (resetValue != null && ResetButton() == true)
          value = new() { colorKeys = resetValue };
      }
      EditorGUILayout.EndHorizontal();
