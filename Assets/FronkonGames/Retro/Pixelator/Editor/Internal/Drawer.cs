...
namespace FronkonGames.Retro.Pixelator
{
  ...
  public abstract partial class Drawer : PropertyDrawer
  {
    ...
    private readonly static string[] descriptions = new string[]
    {
      ...
      "Your pixels... give them to me, now",
      "I need your clothes, your boots, and your pixels",
      "There is no pixel but what we render for ourselves",
      "I'll be pixelated",
      "It's nothing personal",
      "I have come here to chew pixels and kickass, and I'm all out of pixels"
    };

    private readonly static string description = descriptions[UnityEngine.Random.Range(0, descriptions.Length)];
      ...
      BeginVertical();
      {
        ...
        if (styleLogo != null)
        {
          EditorGUILayout.BeginHorizontal();
          {
            ...
            GUILayout.Label("The Pixelator", styleLogo);
          }
