...
namespace FronkonGames.Retro.Pixelator
{
  ...
  public abstract partial class Inspector
  {
    ...
    /// <summary> Vector3Int field with reset. </summary>
    public static Vector3Int Vector3IntField(string label, string tooltip, Vector3Int value, Vector3Int resetValue)
    {
      EditorGUILayout.BeginHorizontal();
      {
        value = EditorGUILayout.Vector3IntField(new GUIContent(label, tooltip), value);
    ...
    public static T ObjectField<T>(string label, string tooltip, T value, T resetValue, bool allowSceneObjects = true) where T : UnityEngine.Object
    {
      EditorGUILayout.BeginHorizontal();
      {
        value = EditorGUILayout.ObjectField(new GUIContent(label, tooltip), value, typeof(T), allowSceneObjects) as T;
